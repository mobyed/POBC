...
from Compiler.library import for_range, for_range_opt, if_,  print_ln
from Compiler.types import program, cgf2n, regint, Matrix, sgf2n, Array, sfix, MultiArray
...
def aes_gcm_128_decrypt(ciphertext, tag, key, nonce):
    ...
    # check = tag_check(tag, tag, bit_decompose=lambda x: x.bit_decompose(8))
